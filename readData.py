...
def readRawData(path='/Users/craigsmith/phoneSensorData/data/'):
    ...
    for e in exercises:
        ...
        for s in subjects:
            ...
            reps = np.unique(reps)
            sensors = ['lac', 'gyr'] #np.unique(sensors)
            rData = {}
            for repx in reps:
...
def readSessionSignals(sensor_order, path='/Users/craigsmith/phoneSensorData/sessions'):
