...
def save_model(model, labels, sensor_order, fs, sample_len, model_name='test'):
    ...
    np.save('model_params/' + model_name + '_sensor_order', sensor_order)
    np.save('model_params/' + model_name + '_fs', fs)
    np.save('model_params/' + model_name + '_sample_len', sample_len)
...
def import_model(model_name):
    ...
    sensor_order = np.load('model_params/' + model_name + '_sensor_order.npy', allow_pickle=True)
    fs = np.load('model_params/' + model_name + '_fs.npy', allow_pickle=True)
    sample_len = np.load('model_params/' + model_name + '_sample_len.npy', allow_pickle=True)
